...
use crate::ui::elements::{
    styles::{
        ...
        CornerRadiusValue, Display as ElementDisplay, FlexDirection, FontStyleValue,
...
fn native_appearance(
    ...
    let default_border_color = Color::from_rgba8(118, 118, 118, 255);
    let border_colors = [
        style.border_top_color.map_or(default_border_color, rgba),
        style.border_right_color.map_or(default_border_color, rgba),
        style.border_bottom_color.map_or(default_border_color, rgba),
        style.border_left_color.map_or(default_border_color, rgba),
    ];
